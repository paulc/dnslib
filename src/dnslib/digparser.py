...
class DigParser:
    ...
    def parseQuestions(self, q, dns):
        for qname, qclass, qtype in q:
            dns.add_question(DNSQuestion(qname, getattr(QTYPE, qtype), getattr(CLASS, qclass)))
...
if __name__ == "__main__":
    ...
    p.add_argument("--dig", action="store_true", default=False, help="Parse DiG output (stdin)")
